...
Axis RX: 
- Mode: CC <input type="checkbox"> Note <input type="checkbox">
	- (if cc): 
		- CC nb: <select> <option>0</option> <option>1</option> <option>10</option><option>Modulation</option></select>            0 or center: <select> <option>0</option> <option>1</option> <option></option></select>                 HiResolution <input type="checkbox">      Sensitivity <select> <option>Linear</option> <option>Log</option> <option></option></select>         Limit min value: 0% Limit max value: 100%
	- (if notes):
		- Scale quantums: <select> <option>Chromatic</option> <option>mixolidian</option></select>      Base Note: <select> <option>C4</option> <option>D2</option> <option>E4</option></select>      Nb of notes: 12
Axis RY
- Mode ........

## HID modes:
- Mode: <select> <option>gamepad</option> <option>mouse</option> <option>keyboard</option></select>
	- (if gamepad): 
	- [ ] Continuous or button press 
		- analog X: <select> <option>RX</option> <option>RY</option> <option>RZ</option></select>
		- ....
TO BE CONTINUED
# Event log:
