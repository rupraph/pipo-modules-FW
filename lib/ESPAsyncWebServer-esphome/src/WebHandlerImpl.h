...
class AsyncStaticWebHandler : public AsyncWebHandler {
 ...
 public:
  ...
  setLastModified();  //sets to current time. Make sure sntp is runing and time is updated
#endif
  AsyncStaticWebHandler& setTemplateProcessor(
      AwsTemplateProcessor newCallback) {
