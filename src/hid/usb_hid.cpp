...
void usb_hid::usb_hid_setup() {
  ...
  // wait until device mounted. then timeout after 5 seconds and report not
  // mounted
...
/// Find way on assigning sensor axis to game or mouse axis. this mapping should
/// likely be in engine or a seperate calss than here.
