...
class usb_hid {
        ...
        private:
                ...
                std::unordered_map<std::string, GamepadPtr> GamepadMap ={
                        ...
                        {"x", &hid_gamepad_report_t::x},
                        {"y", &hid_gamepad_report_t::y},
                        {"z", &hid_gamepad_report_t::z},
                        {"rz", &hid_gamepad_report_t::rz},
                        {"rx", &hid_gamepad_report_t::rx},
                        {"ry", &hid_gamepad_report_t::ry},
