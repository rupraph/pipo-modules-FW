...
// not ready yet. dealing with custom scale or additional scale is not ready to
// be savec/loaded correctly

// void MidiTranslator::set_new_scale(string newscaleType,vector<string>
// newscale) {
