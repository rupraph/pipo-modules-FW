...
ArduinoICM20948Settings icmSettings = {
    ...
    .linearAcceleration_frequency =
        1,                        // Max frequency = 225, min frequency = 1
...
void run_icm20948_quat6_controller(bool inEuler = false) {
  ...
  if (inEuler) {
    if (icm20948.euler6DataIsReady()) {
      ...
      sprintf(sensor_string_buff, "Euler6 roll, pitch, yaw(deg): [%f,%f,%f]",
              roll, pitch, yaw);
    ...
    if (icm20948.quat6DataIsReady()) {
      ...
      sprintf(sensor_string_buff, "Quat6 w, x, y, z (deg): [%f,%f,%f,%f]",
...
void run_icm20948_quat9_controller(bool inEuler = false) {
  ...
  if (inEuler) {
    if (icm20948.euler9DataIsReady()) {
      ...
      sprintf(sensor_string_buff, "Euler9 roll, pitch, yaw(deg): [%f,%f,%f]",
              roll, pitch, yaw);
      Serial.println(sensor_string_buff);
    }
  } else {
    if (icm20948.quat9DataIsReady()) {
      ...
      sprintf(sensor_string_buff, "Quat9 w, x, y, z (deg): [%f,%f,%f,%f]",
              quat_w, quat_x, quat_y, quat_z);
      Serial.println(sensor_string_buff);
    }
  }
...
void run_icm20948_accel_controller() {
  ...
  if (icm20948.accelDataIsReady()) {
    ...
    sprintf(sensor_string_buff, "Acceleration x, y, z (g): [%f,%f,%f]", x, y,
            z);
    Serial.println(sensor_string_buff);
  }
}
void run_icm20948_gyro_controller() {
  ...
  if (icm20948.gyroDataIsReady()) {
    ...
    sprintf(sensor_string_buff, "Gyroscope x, y, z (rad/s): [%f,%f,%f]", x, y,
            z);
    Serial.println(sensor_string_buff);
  }
}
void run_icm20948_mag_controller() {
  ...
  if (icm20948.magDataIsReady()) {
    ...
    sprintf(sensor_string_buff, "Magnetometer x, y, z (mT): [%f,%f,%f]", x, y,
            z);
    Serial.println(sensor_string_buff);
  }
}
void run_icm20948_linearAccel_controller() {
  ...
  if (icm20948.linearAccelDataIsReady()) {
    ...
    sprintf(sensor_string_buff, "Linear Acceleration x, y, z (g): [%f,%f,%f]",
            x, y, z);
    Serial.println(sensor_string_buff);
  }
}
void run_icm20948_grav_controller() {
  ...
  if (icm20948.gravDataIsReady()) {
    ...
    sprintf(sensor_string_buff, "Gravity Vector x, y, z (g): [%f,%f,%f]", x, y,
            z);
    Serial.println(sensor_string_buff);
  }
}
